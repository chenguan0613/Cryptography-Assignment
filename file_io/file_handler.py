...
class FileHandler:
    #(.key)
    @staticmethod
    def save_key_file(key_data_dict,file_path="secret.key"):
        file=open(file_path,"w",encoding="utf-8")
        json.dump(key_data_dict,file,indent=4)
        file.close()
        return file_path
    @staticmethod
    def load_key_file(file_path="secret.key"):
        file=open(file_path,"r",encoding="utf-8")
        key_data_dict=json.load(file)
        file.close()
        return key_data_dict
    @staticmethod
    def save_encrypted_file(iv_hex,ciphertext_hex,file_path="message.enc"):
        ...
        return file_path
    @staticmethod
    def load_encrypted_file(file_path="message.enc"):
        file=open(file_path,"r",encoding="utf-8")
    ...
    @staticmethod
    def save_decrypted_file(plaintext,file_path="recovered.dec"):
        file=open(file_path,"w",encoding="utf-8")
